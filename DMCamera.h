...
public:
  ...
  STDMETHOD(SetupFileSaving2)(/*[in]*/long rotationFlip, /*[in]*/BOOL filePerImage, /*[in]*/double pixelSize, /*[in]*/long flags, /*[in]*/double numGrabSum, /*[in]*/double frameThresh, /*[in]*/double threshFracPlus, /*[in]*/double dummy4, /*[in]*/long nameSize, /*[in, size_is(nameSize)]*/long names[], /*[out]*/long *error);
  ...
  STDMETHOD(SetupFrameAligning)(/*[in]*/long aliBinning, /*[in]*/double rad2Filt1, /*[in]*/double rad2Filt2, /*[in]*/double rad2Filt3, /*[in]*/double sigma2Ratio, /*[in]*/double truncLimit, /*[in]*/long alignFlags, /*[in]*/long gpuFlags, /*[in]*/long numAllVsAll, /*[in]*/long groupSize, /*[in]*/long shiftLimit, /*[in]*/long antialiasType, /*[in]*/long refineIter, 
    /*[in]*/double stopIterBelow, /*[in]*/double refRad2, /*[in]*/long nSumAndGrab, /*[in]*/long frameStartEnd, /*[in]*/long frameThreshes, /*[in]*/double dumDbl1, /*[in]*/long stringSize, /*[in, size_is(stringSize)]*/long strings[], /*[out]*/long *error);
  ...
  STDMETHOD(GetTiltSumProperties)(/*[out]*/long *index, /*[out]*/long *numFrames, /*[out]*/double *angle, /*[out]*/long *firstSlice, /*[out]*/long *lastSlice, /*[out]*/long *dumInt1, /*[out]*/double *dumDbl1, /*[out]*/double *dumDbl2);
};
